    ...
    <>
      ...
      {showSettingsModal && (
        ...
        >
          ...
          <Modal.Body>
            <div className="fs-18 text-muted mb-2">
              {t("settings.assetsHeader")}
            </div>
            <div className="d-flex justify-content-between mb-1">
              <div className="text-muted">
                {t("settings.showCommunityAssets")}
              </div>
              <div>
                <Form.Check
                  type="switch"
                  onChange={(event: React.ChangeEvent<HTMLInputElement>) => {
                    dispatch(
                      setExcludeCommunityAssets(
                        !settings.excludeCommunityAssets
                      )
                    );
                  }}
                  checked={!settings.excludeCommunityAssets}
                />
              </div>
            </div>

            <div className="fs-18 text-muted mb-2 mt-3">
            ...
            <Row className="align-items-center mx-0">
              <Col
                xs={4}
                lg={3}
                className="order-2 order-lg-1 mb-2 mb-lg-0 px-1"
              >
                <a
              ...
              <Col
                xs={4}
                lg={3}
                className="order-3 order-lg-2 mb-2 mb-lg-0 px-1"
              >
                <a
                  style={{ cursor: "pointer" }}
              ...
              <Col
                xs={4}
                lg={3}
                className="order-4 order-lg-3 mb-2 mb-lg-0 px-1"
              >
                <a
                  style={{ cursor: "pointer" }}
