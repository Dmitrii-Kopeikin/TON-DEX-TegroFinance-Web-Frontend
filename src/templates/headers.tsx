...
export function DefaultHeader() {
    ...
    const { walletInfo, setReferral } = useContext(
        DexContext
    ) as DexContextType;
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            <div className="ms-3">
                                                Payment system
                                                <div className="text-muted small">
                                                    Connection of payment
                                                    systems and banks without
                                                    commissions.
                                                </div>
                                            </div>
                                        </NavDropdown.Item>
                                        ...
                                        >
                                            ...
                                            <div className="ms-3">
                                                Affiliate program
                                                <div className="ms-1 u-badge">
                                                    new
                                                </div>
                                                <div className="text-muted small">
                                                    Invite clients and get
